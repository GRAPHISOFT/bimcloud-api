...
class Workflow:
	...
	def run(self):
		...
		try:
			...
			# test = self._manager_api.get_items_by_criterion(self._auth_context, 'tags')
			...
			test = self._manager_api.assign_private_tag(self._auth_context, '9092251A-F027-4F78-88AA-8C341A94B0E8', 'c89343b3-3c26-1844-8eaf-af85898608d9')
